        ...
        if msg.name == "text":
            ...
            if "error" in message_data and message_data["error"] == "Auth not valid":
                ...
                if message_data["type"] == "question":
                    ...
                    # f"Question {message_data['questionNumber']} out of {message_data['questionCount']}")
                    print(f"{Fore.CYAN}{question_str}\n{answers}{Style.RESET_ALL}")
                    data = {"answers": answers, "question_str": question_str, "question_number": message_data['questionNumber'], "question_count": message_data['questionCount']}
                    return data
    print("Socket closed")
